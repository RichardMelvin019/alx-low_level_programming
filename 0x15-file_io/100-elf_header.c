...
void print_abi(unsigned char *e_abi);
void print_osabi(unsigned char *e_osabi);
void print_type(unsigned int e_type, unsigned char *e_type);
void print_entry(unsigned long int e_entry, unsigned char *e_entry);
